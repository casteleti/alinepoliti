...
function page_label_map(): array
{
    return [
        ...
        '/supervisao-clinica-online' => 'Supervisão Clínica Online',
        '/supervisao-em-tcc' => 'Supervisão em TCC',
        '/supervisao-para-psicologos-iniciantes' => 'Supervisão para Iniciantes',
        '/supervisao-de-casos-clinicos' => 'Supervisão de Casos Clínicos',
        '/orientacao-de-pais-online' => 'Orientação de Pais Online',
        '/orientacao-de-pais-tdah' => 'Orientação de Pais para TDAH',
        '/orientacao-de-pais-ansiedade-infantil' => 'Ansiedade Infantil',
        '/orientacao-de-pais-birras-e-limites' => 'Birras, Limites e Rotina',
