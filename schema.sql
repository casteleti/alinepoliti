...
('Você atende crianças?', 'O atendimento clínico individual é para adolescentes (a partir de 14 anos) e adultos. Para crianças, ofereço o serviço de Orientação de Pais.', 5),
...
('Você atende Unimed ou algum outro convênio?', 'Com toda a transparência: no momento não atendo por convênios — incluindo a Unimed. Sei que isso pode pesar na sua decisão, e por isso a primeira sugestão é entrar em contato com o seu plano de saúde para conhecer os profissionais credenciados disponíveis. Se você preferir seguir com o atendimento particular, será um prazer acolher você — e emito recibo que pode ser usado para solicitar reembolso ao seu plano (conforme as regras de cada convênio) e na declaração de Imposto de Renda. Fico à disposição para conversarmos sobre o que faz mais sentido para o seu momento.', 7),
